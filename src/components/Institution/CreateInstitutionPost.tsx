...
const CreateInstitutionPost = () => {
  ...
  if (!user || user.restrictions.isPostBlocked) return null;

  return (
    <div className="rounded-lg border border-gray-400 bg-white p-3 shadow">
      {
